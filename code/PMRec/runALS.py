...
def run(param, data_dict=None):
    ...
    # write params
    # remove some configurations if it is als
    if param['model_type'] == 'als':
        del param['step_size']
...
if __name__ == '__main__':
    ...
    feature_list = ['step']
#    n_iter_list = [1000, 10000, 50000, 75000]
    n_iter_list = [0]
#    rank_list = [8, 10, 20, 50, 100]
    rank_list = [20]
#    init_stdev_list = [.1, .01, .5]
    init_stdev_list = [.01]
#    l2_reg_w_list = [.1, .01, .5]
    l2_reg_w_list = [.1]
#    l2_reg_V_list = [.1, .01, .5]
    l2_reg_V_list = [.5]
#    l2_reg_list = [0., .1, .5]
    l2_reg_list = [0]
    step_size_list = [.1, .01, .05]
    # ALS configurations
    max_iter = 10000
    step_size_als = 1
    stop_delta = .01
    ...
    for log_dir, stepsz, negative_sample in configs_major:
        ...
        for feature, rank, n_iter, init_stdev, l2_reg_w, \
            ...
            result_dir = base_dir + os.sep + 'stepO19Jul' + os.sep + \
