...
if __name__ == '__main__':
    ...
    feature_list = ['step_lc']
    n_iter_list = [10000, 50000, 75000]
    ...
    for log_dir, stepsz, negative_sample in configs_major:
        ...
        for feature, rank, n_iter in configs_minor:
            param = dict()
            param['stepsz'] = stepsz
            ...
            result_dir = base_dir + os.sep + 'stepLifecycle' + os.sep + \
