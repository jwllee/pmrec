...
#        print('gt_next_act: {}'.format(gt_next_act))
        ...
        if negative_samples > -1:
            ...
            # select all the possible activities
...
#        print('activity list: {}'.format(activity_list))
        ...
        # check dimensions
        assert  (taken_shape[0] == next_shape[0]), \
                'taken shape: {}, next shape: {}'\
        ...
        x_shape_i = np.asarray((len(samples), len(step_list) + \
                                len(activity_list)))
