...
#                                                               param['train_perc'])
        train_cid_list, valid_cid_list, test_cid_list = \
                fmexp.train_valid_test_split(cid_list, \
                                             train_perc=param['train_perc'], \
                                             valid_perc=param['valid_perc'])
...
if __name__ == '__main__':
    ...
    for log_dir, stepsz, negative_sample in configs_major:
        ...
        for feature, rank, n_iter, init_stdev, l2_reg_w, \
            ...
            # parameters for validation of als fm model
            ...
            result_dir = base_dir + os.sep + 'stepAmtOFullALS' + os.sep + \
